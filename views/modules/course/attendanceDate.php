...
if(isset($_POST['courseId'])){
  //echo 'llego por post courseId';
//echo $_POST['id'];
$dateSelect=date("Y-m-d",strtotime($_POST["date"]));

  $registro = new ControllerCourse();
  $viewCourse = $registro->viewStudentController($_POST['courseId']);
  ...
  <table class="table table-sm table-bordered">
        ...
        foreach ($viewCourse as $key => $item) {
  				...
  				$searchAttendance = $attendanceStudent->viewAttendanceStudentController($item["student_id"],$dateSelect);
  ...
  ?>
  <input type="hidden" name="saveAttendance" value="">
...
<?php
  ...
  <form class="" action="" method="post">
    ...
    <input type="submit" name="" value="Tomar Asistencia">
  </form>
  <?php
}
